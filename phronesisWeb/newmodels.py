...
class Dependency(models.Model):
    ...
    id_prior = models.ForeignKey('Metaagent', null=True, db_column='id_prior', blank=True)
    id_after = models.ForeignKey('Metaagent', null=True, db_column='id_after', blank=True)
...
class Fileagent(models.Model):
    ...
    maxdepth = models.IntegerField(null=True, db_column='maxDepth', blank=True) # Field name made lowercase.
    class Meta:
        db_table = 'FileAgent'
...
class Metaagenttree(models.Model):
    id = models.IntegerField(primary_key=True)
    id_parent = models.ForeignKey(Metaagent, null=True, db_column='id_parent', blank=True)
    id_daughter = models.ForeignKey(Metaagent, null=True, db_column='id_daughter', blank=True)
...
class Recoveryrule(models.Model):
    id = models.IntegerField(primary_key=True)
    id_ma1 = models.ForeignKey(Metaagent, null=True, db_column='id_ma1', blank=True)
    action1 = models.CharField(max_length=45L, blank=True)
    id_ma2 = models.ForeignKey(Metaagent, null=True, db_column='id_ma2', blank=True)
